...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{figures/main_menu.png}
\caption{Main menu of the Disaster Survival Simulator, showing the project identity and entry points for training, dashboard review, and presentation.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.74\textheight,keepaspectratio]{figures/module_progress.png}
\caption{Flood module-selection screen with progress, score bars, pass/fail labels, attempts, and phase grouping across the scenario sequence.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,height=0.76\textheight,keepaspectratio]{figures/dashboard_overview.png}
\caption{Readiness dashboard showing overall grade, phase-wise knowledge snapshot, module-by-module performance, failed attempts, retries, and skill-profile analysis.}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/game_gobag.png}
\caption{Module 1 visual: the Go-Bag Challenge begins with a flash-flood warning, time pressure, weight limit, family needs, and essential-item guidance.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/game_triage.png}
\caption{Module 4 visual: Field Triage introduces medical prioritization, supply collection, and correct treatment decisions after survivors reach shelter.}
\end{figure}
